...
window.addEventListener("load", () => {
  setTimeout(()=>{utter.text ="يوجد ثمان طرق متاحة.. برجاء اختيار الطريق المرغوب من الطرق التالية:"; synth.speak(utter);}, "5000");
  setTimeout(()=>{utter.text ="الطريق رقم واحد: ست وثمانون دقيقة"; synth.speak(utter);}, "15000");
  setTimeout(()=>{utter.text ="الطريق رقم اثنين: ست وثمانون دقيقة"; synth.speak(utter);}, "20000");
  setTimeout(()=>{utter.text ="الطريق رقم ثلاثة: ست وثمانون دقيقة"; synth.speak(utter);}, "25000");
  setTimeout(()=>{utter.text ="الطريق رقم اربعة: ست وثمانون دقيقة"; synth.speak(utter);}, "30000");
  setTimeout(()=>{utter.text ="الطريق رقم خمسة: مائة وعشرة دقيقة"; synth.speak(utter);}, "35000");
  setTimeout(()=>{utter.text ="الطريق رقم ستة: مائة وعشرة دقيقة"; synth.speak(utter);}, "40000");
  setTimeout(()=>{utter.text ="الطريق رقم سبعة: مائة وعشرة دقيقة"; synth.speak(utter);}, "45000");
  setTimeout(()=>{utter.text ="الطريق رقم ثمانية: مائة وعشرة دقيقة"; synth.speak(utter);}, "50000");
  setTimeout(()=>{utter.text ="للاختيار قل: الطريق رقم:"; synth.speak(utter);}, "55000");
});
